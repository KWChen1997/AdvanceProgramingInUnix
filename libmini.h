...
// Copied from glibc/sysdeps/unix/sysv/linux/bits/sigaction.h
...
long sys_rt_sigaction(int sig, struct ksigaction *act, struct ksigaction *oact, size_t sigsetsize);
long myrt(void);
